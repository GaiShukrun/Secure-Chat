...
def start_client():
    ...
    # Initialize Bob and MongoDB storage
    ...
    try:
        ...
        dh_key_info = {
            'private_key': bob.dh_private,  # The secret exponent
            'public_key': bob_public_dh,    # The calculated public value
            'base': dh_params['base'],
            'modulus': dh_params['modulus']
        }
        storage.store_dh_private_key('Bob', dh_key_info)
        ...
        storage.store_shared_key('Bob', key_info)
